...
import com.a_track_it.fitdata.adapter.SettingsLogoAdapter;
import com.a_track_it.fitdata.adapter.SimpleListAdapter;
...
public class SettingsDialog extends DialogFragment {
    ...
    public void onDismiss(@NonNull DialogInterface dialog) {
        ...
        //if (context != null) context.sendBroadcast(refreshIntent);
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        WorkoutViewModelFactory factory = com.a_track_it.fitdata.common.InjectorUtils.getWorkoutViewModelFactory(context.getApplicationContext());
        ...
        final Drawable drawableUnChecked = AppCompatResources.getDrawable(context,R.drawable.ic_close_white);
        Utilities.setColorFilter(drawableUnChecked,ContextCompat.getColor(context, R.color.secondaryTextColor));
        final Drawable drawableDeniedLocation = AppCompatResources.getDrawable(context,R.drawable.ic_location_disabled_white);
        ...
        final Drawable drawableProgressed = AppCompatResources.getDrawable(context,R.drawable.progress_list1);
        Utilities.setColorFilter(drawableProgressed,ContextCompat.getColor(context, R.color.primaryLightColor));
       ...
       logoAdapter.setOnItemClickListener(new SettingsLogoAdapter.OnItemClickListener() {
           @Override
           public void onItemClick(View view, boolean useRounded, int position) {
       ...
       final String sUser = (mGoogleAccount != null) ? mGoogleAccount.getDisplayName() : userPrefs.getLastUserName();
        ...
        btnSettingsDeviceIntPlus.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
        ...
        if (userPrefs.getPrefByLabel(Constants.USER_PREF_SHOW_GOALS))
            settings_show_goals_toggle.setIcon(drawableChecked);
        else
            settings_show_goals_toggle.setIcon(drawableUnChecked);
...
/*
        ...
        settings_firebase_toggle.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                boolean isChecked = !userPrefs.getUseFirebase();
                userPrefs.setUseFirebase(isChecked);
                if (isChecked) {
                    ((com.google.android.material.button.MaterialButton) v).setText(getString(R.string.label_settings_firebase_online));
                    ((com.google.android.material.button.MaterialButton) v).setIcon(drawableChecked);
                }else {
                    ((com.google.android.material.button.MaterialButton) v).setText(getString(R.string.label_settings_firebase_offline));
                    ((com.google.android.material.button.MaterialButton) v).setIcon(drawableUnChecked);
                }
            }
        });*/
        if (lHistoryStart == 0) {
        ...
        boolean bTemp = userPrefs.getPrefByLabel(Constants.USER_PREF_USE_NOTIFICATION);
        ...
        confirm_start_toggle.setChecked(userPrefs.getConfirmStartSession());
        ...
        confirm_set_toggle.setChecked(userPrefs.getConfirmSetSession());
        ...
        confirm_deletetoggle.setChecked(userPrefs.getConfirmDeleteSession());
        ...
        confirm_end_toggle.setChecked(userPrefs.getConfirmEndSession());
        ...
        confirm_exit_toggle.setChecked(userPrefs.getConfirmExitApp());
        confirm_end_toggle.setChecked(userPrefs.getConfirmExitApp());
        if (userPrefs.getConfirmExitApp())
        ...
        settings_use_kg.setChecked(userPrefs.getUseKG());
        if (userPrefs.getUseKG()) {
        ...
        boolean bLocationPermission = (ActivityCompat.checkSelfPermission(context, Manifest.permission.ACCESS_FINE_LOCATION) == PackageManager.PERMISSION_GRANTED);
        ...
        btnSettingsSetsPlus.setOnClickListener(v -> {
        ...
        btnSettingsSetsMinus.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
        ...
        btnSettingsRepsPlus.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Integer lValue = userPrefs.getDefaultNewReps() + 1;
                String sText = Integer.toString(lValue);
                userPrefs.setDefaultNewReps(lValue);
                mSavedStateViewModel.setRepsDefault(lValue);
        ...
        btnSettingsRepsMinus.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
        ...
        btnConfirmDurationMinus.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Long lValue = TimeUnit.MILLISECONDS.toSeconds(userPrefs.getConfirmDuration());
                if ((lValue-1) >= 0) lValue--;
                String sText = Long.toString(lValue);
                userPrefs.setConfirmDuration(TimeUnit.SECONDS.toMillis(lValue));
                btnConfirmDuration.setText(sText);
            }
        ...
        btnSettingsDailyPlus.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                ...
                appPrefs.setDailySyncInterval(TimeUnit.MINUTES.toMillis(lValue));
            }
        });
        ...
        String sLabelS = context.getString(com.a_track_it.fitdata.common.R.string.label_sensor_name) + "step";
        String sDeviceName;
        ...
        sLabelS = context.getString(com.a_track_it.fitdata.common.R.string.label_sensor_name) + "bpm";
        if ((sensorCount > 0)){
            sDeviceName = appPrefs.getPrefStringByLabel(sLabelS);
            ...
            btnBPMSampleRateMinus.setOnClickListener(v -> {
                Long lValue16 = userPrefs.getBPMSampleRate() - 10;
                String sText16 = Long.toString(lValue16);
                userPrefs.setBPMSampleRate(lValue16);
                resetBindings = true;
                btnBPMSampleRate.setText(sText16);
            });
        }else{
        ...
        sLabelS = context.getString(com.a_track_it.fitdata.common.R.string.label_sensor_name) + "step";
        if (appPrefs.getPrefStringByLabel(sLabelS).length() > 0) sensorCount++;
        ...
        if (sensorCount > 0){
            ...
            if (appPrefs.getTempSensorCount() > 0) {
                sLabelS = context.getString(com.a_track_it.fitdata.common.R.string.label_sensor_name) + "temp";
            ...
            if (appPrefs.getPressureSensorCount() > 0) {
                sLabelS = context.getString(com.a_track_it.fitdata.common.R.string.label_sensor_name) + "hPa";
                if (appPrefs.getPrefStringByLabel(sLabelS).length() > 0)
                    otherDeviceList.add(appPrefs.getPrefStringByLabel(sLabelS));
            }
            if (appPrefs.getHumiditySensorCount() > 0) {
                sLabelS = context.getString(com.a_track_it.fitdata.common.R.string.label_sensor_name) + "humidity";
                if (appPrefs.getPrefStringByLabel(sLabelS).length() > 0)
                    otherDeviceList.add(appPrefs.getPrefStringByLabel(sLabelS));
            }
           // ((TextView)rootView.findViewById(R.id.other_sample_devicelabel)).setText(sDeviceName);
            ...
            rootView.findViewById(R.id.btnOtherSampleRatePlus).setVisibility(View.GONE);
            rootView.findViewById(R.id.btnOtherSampleRateMinus).setVisibility(View.GONE);
            rootView.findViewById(R.id.btnOtherSampleRate).setVisibility(View.GONE);
        }
        sDeviceName = Constants.ATRACKIT_EMPTY;
        otherDeviceList.add("Google Sensors");
        sLabelS = context.getString(com.a_track_it.fitdata.common.R.string.label_fit_sensor) + DataType.TYPE_STEP_COUNT_DELTA.getName();
        String sLabelSource = context.getString(com.a_track_it.fitdata.common.R.string.label_fit_name) + DataType.TYPE_STEP_COUNT_DELTA.getName();
        if (appPrefs.getPrefByLabel(sLabelS)){
        ...
        sLabelS = context.getString(com.a_track_it.fitdata.common.R.string.label_fit_sensor) + DataType.TYPE_HEART_RATE_BPM.getName();
        sLabelSource = context.getString(com.a_track_it.fitdata.common.R.string.label_fit_name) + DataType.TYPE_HEART_RATE_BPM.getName();
        if (appPrefs.getPrefByLabel(sLabelS)){
            if (appPrefs.getPrefStringByLabel(sLabelSource).length() > 0)
        ...
        sLabelS = context.getString(com.a_track_it.fitdata.common.R.string.label_fit_sensor) + DataType.TYPE_LOCATION_SAMPLE.getName();
        sLabelSource = context.getString(com.a_track_it.fitdata.common.R.string.label_fit_name) + DataType.TYPE_LOCATION_SAMPLE.getName();
        if (appPrefs.getPrefByLabel(sLabelS)){
            if (appPrefs.getPrefStringByLabel(sLabelSource).length() > 0)
        ...
        sLabelS = context.getString(com.a_track_it.fitdata.common.R.string.label_fit_sensor) + DataType.TYPE_WORKOUT_EXERCISE.getName();
        sLabelSource = context.getString(com.a_track_it.fitdata.common.R.string.label_fit_name) + DataType.TYPE_WORKOUT_EXERCISE.getName();
        if (appPrefs.getPrefByLabel(sLabelS)){
            if (appPrefs.getPrefStringByLabel(sLabelSource).length() > 0)
        ...
        sLabelS = context.getString(com.a_track_it.fitdata.common.R.string.label_fit_sensor) + DataType.TYPE_CALORIES_EXPENDED.getName();
        sLabelSource = context.getString(com.a_track_it.fitdata.common.R.string.label_fit_name) + DataType.TYPE_CALORIES_EXPENDED.getName();
        if (appPrefs.getPrefByLabel(sLabelS)){
            if (appPrefs.getPrefStringByLabel(sLabelSource).length() > 0)
        ...
        sLabelS = context.getString(com.a_track_it.fitdata.common.R.string.label_fit_sensor) + DataType.TYPE_MOVE_MINUTES.getName();
        sLabelSource = context.getString(com.a_track_it.fitdata.common.R.string.label_fit_name) + DataType.TYPE_MOVE_MINUTES.getName();
        if (appPrefs.getPrefByLabel(sLabelS)){
            if (appPrefs.getPrefStringByLabel(sLabelSource).length() > 0)
        ...
        sLabelS = context.getString(com.a_track_it.fitdata.common.R.string.label_fit_sensor) + DataType.TYPE_HEART_POINTS.getName();
        sLabelSource = context.getString(com.a_track_it.fitdata.common.R.string.label_fit_name) + DataType.TYPE_HEART_POINTS.getName();
        if (appPrefs.getPrefByLabel(sLabelS)){
            if (appPrefs.getPrefStringByLabel(sLabelSource).length() > 0)
    ...
    private boolean hasOAuthPermission() {
        FitnessOptions fitnessOptions = mReferenceTools.getFitnessSignInOptions(1);
