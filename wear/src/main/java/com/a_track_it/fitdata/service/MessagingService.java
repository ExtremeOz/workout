...
import com.a_track_it.fitdata.model.Conversations;
...
public class MessagingService extends IntentService {
    ...
    public static final String SEND_MESSAGE_ACTION =
            "com.a_track_it.fitdata.ACTION_SEND_MESSAGE";
    public static final String READ_ACTION =
            "com.a_track_it.fitdata.ACTION_MESSAGE_READ";
    public static final String REPLY_ACTION =
            "com.a_track_it.fitdata.ACTION_MESSAGE_REPLY";
    ...
    private void sendNotificationForConversation(
        ...
        Bitmap bitmap = BitmapFactory.decodeResource(
                getApplicationContext().getResources(), R.drawable.ic_bench);
