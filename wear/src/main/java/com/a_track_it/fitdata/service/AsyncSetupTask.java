...
import com.a_track_it.fitdata.activity.IInitialActivityCallback;
...
private IInitialActivityCallback callback;
    ...
    protected Integer doInBackground(Void... params) {
        ...
        while (i < bp_ids.length){
            ...
            bodypart.regionID = bp_regionid[i];
            ...
            bodypart.parentID = bp_parentids[i];
