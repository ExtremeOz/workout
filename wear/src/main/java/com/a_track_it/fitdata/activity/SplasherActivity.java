...
import com.a_track_it.fitdata.common.data_model.LicenceJobIntentService;
...
import static com.a_track_it.fitdata.common.Constants.ATRACKIT_ATRACKIT_CLASS;
...
import static com.a_track_it.fitdata.common.Constants.INTENT_PERMISSION_AGE;
import static com.a_track_it.fitdata.common.Constants.INTENT_PERMISSION_LOCATION;
import static com.a_track_it.fitdata.common.Constants.INTENT_PERMISSION_POLICY;
import static com.a_track_it.fitdata.common.Constants.INTENT_PERMISSION_SENSOR;
...
import static com.a_track_it.fitdata.common.Constants.KEY_FIT_TIME;
...
import static com.a_track_it.fitdata.common.Constants.KEY_PAYLOAD;
import static com.a_track_it.fitdata.common.Constants.MAINTAIN_CHANNEL_ID;
import static com.a_track_it.fitdata.common.Constants.QUESTION_AUDIO;
import static com.a_track_it.fitdata.common.Constants.QUESTION_DEVICE;
import static com.a_track_it.fitdata.common.Constants.QUESTION_NOTIFY;
import static com.a_track_it.fitdata.common.Constants.QUESTION_VIBRATE;
import static com.a_track_it.fitdata.common.Constants.SUMMARY_CHANNEL_ID;
import static com.a_track_it.fitdata.common.Constants.USER_PREF_RECOG;
    ...
    public void onRequestPermissionsResult(int requestCode, @NonNull String[] permissions, @NonNull int[] grantResults) {
        ...
        if (requestCode == PERMISSION_REQUEST_BODY_SENSORS) {
            ...
            if ((grantResults.length == 1) && (grantResults[0] == PackageManager.PERMISSION_GRANTED)) {
                ...
                String sLabelName = getString(com.a_track_it.fitdata.common.R.string.label_sensor_name) + "bpm";
                ...
                sLabelName = getString(com.a_track_it.fitdata.common.R.string.label_sensor_name) + "step";
                appPrefs.setPrefByLabel(sLabel, bAvail);
                wakefulIndex = 0;
                if (bAvail)
                ...
                sLabelName = getString(com.a_track_it.fitdata.common.R.string.label_sensor_name) + "hPa";
                appPrefs.setPrefByLabel(sLabel, bAvail);
                wakefulIndex = 0;
                if (bAvail)
                ...
                sLabelName = getString(com.a_track_it.fitdata.common.R.string.label_sensor_name) + "temp";
                appPrefs.setPrefByLabel(sLabel, bAvail);
                wakefulIndex = 0;
                if (bAvail)
                ...
                sLabelName = getString(com.a_track_it.fitdata.common.R.string.label_sensor_name) + "humidity";
                appPrefs.setPrefByLabel(sLabel, bAvail);
                wakefulIndex = 0;
                if (bAvail)
...
/*                            if (sIntent2.equals(Constants.USER_PREF_USE_NOTIFICATION)
    ...
    private String checkApplicationSetup(){
       ...
       // boolean bSetup = appPrefs.getAppSetupCompleted();
        if (appPrefs.getLastUserID().length() > 0){
            ...
            if (intentString.length() == 0)
                if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.Q) {
                    if (((userPrefs != null) && !userPrefs.getPrefByLabel(Constants.USER_PREF_RECOG_ASKED))
                        ...
                        if (userPrefs != null && !userPrefs.getPrefByLabel(Constants.LABEL_DEVICE_ASKED))
            ...
            if (appPrefs.getLastUserID().length() == 0) intentString = ATRACKIT_ATRACKIT_CLASS;
            if (intentString.length() == 0)
                if (ActivityCompat.checkSelfPermission(getApplicationContext(), Manifest.permission.BODY_SENSORS) != PackageManager.PERMISSION_GRANTED) intentString = INTENT_PERMISSION_SENSOR;
            if (intentString.length() == 0)
                if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.Q) {
                    if (ContextCompat.checkSelfPermission(getApplicationContext(), Manifest.permission.ACTIVITY_RECOGNITION) != PackageManager.PERMISSION_GRANTED)
                        intentString = Constants.INTENT_PERMISSION_RECOG;
    ...
    private void doGetTotalsRefresh(){
        ...
        final String[] mins_list = getResources().getStringArray(com.a_track_it.fitdata.common.R.array.minutes_list);
