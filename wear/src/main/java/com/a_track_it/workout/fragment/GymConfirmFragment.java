...
public class GymConfirmFragment extends Fragment implements AmbientInterface{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        boolean bUseTimedRest = userPrefs.getTimedRest();
        ...
        MaterialButton btnConfirmAddExercise = rootView.findViewById(R.id.btnConfirmAddExercise);
        btnConfirmAddExercise.setTag(Constants.UID_btnAddExercise);
        MaterialButton btnMinusWeight = rootView.findViewById(R.id.btnWeightMinus);
        btnMinusWeight.setTag(Constants.UID_btnWeightMinus);
        MaterialButton btnPlusWeight = rootView.findViewById(R.id.btnWeightPlus);
        btnPlusWeight.setTag(Constants.UID_btnWeightPlus);
        MaterialButton btnMinusReps = rootView.findViewById(R.id.btnRepsMinus);
        btnMinusReps.setTag(Constants.UID_btnRepsMinus);
        MaterialButton btnPlusReps = rootView.findViewById(R.id.btnRepsPlus);
        ...
        MaterialButton confirm_use_timed_rest_toggle = rootView.findViewById(R.id.confirm_timed_rest_toggle);
    ...
    private void observerSet(WorkoutSet set){
        ...
        Log.e(LOG_TAG, "observerSet " + currentIndex + " setIndex" + setIndex + " "  + set.toString());
        ...
        final String sTop = LABEL_LAST_SET;
