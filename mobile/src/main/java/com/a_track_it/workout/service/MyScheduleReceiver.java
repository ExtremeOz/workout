...
public class MyScheduleReceiver extends BroadcastReceiver {
    ...
    private static final String ALARM_ID = "com.a_track_it.workout.MyScheduleReceiver";
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        if (currentTime - appPrefs.getLastSync() < (REPEAT_TIME * 2) && intent.getAction().equals("com.a_track_it.com.workout.START_REFRESH")) {
