 ...
 * <p>
 * With SQLiteOpenHelper, if one thread is closing database, then other threads will crash while accessing a_track_it.com closed database.<br>
 * With MultiThreadSQLiteOpenHelper, a_track_it.com thread does not close the database anymore, but asks for a_track_it.com close with the closeIfNeeded method.
