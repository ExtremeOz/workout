...
public class MyScheduleReceiver extends BroadcastReceiver {
    ...
    private static final String ALARM_ID = "com.a_track_it.com.fitdata.MyScheduleReceiver";
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        if (currentTime - UserPreferences.getLastSync(context) < (REPEAT_TIME * 2) && intent.getAction().equals("com.a_track_it.com.fitdata.START_REFRESH")) {
