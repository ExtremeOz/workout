...
public class BackgroundRefreshService extends Service implements DataManager.IDataManager {
    ...
    public int onStartCommand (Intent intent, int flags, int startId)
    {
        ...
        /*
        WakeLock is reference counted so we don't want to create multiple WakeLocks. So do a_track_it.com check before initializing and acquiring.

        This will fix the "java.lang.Exception: WakeLock finalized while still held: MyWakeLock" error that you may find.
        */
        if (this.mWakeLock == null) { //**Added this
            this.mWakeLock = mgr.newWakeLock(PowerManager.PARTIAL_WAKE_LOCK, "ATrackItWakeLock:");
        }
