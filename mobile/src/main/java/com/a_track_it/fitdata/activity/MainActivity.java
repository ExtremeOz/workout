...
import com.a_track_it.fitdata.adapter.MainViewPagerAdapter;
...
import com.a_track_it.fitdata.fragment.CustomActivityListDialog;
...
import com.a_track_it.fitdata.fragment.GymConfirmFragment;
import com.a_track_it.fitdata.fragment.HomeFragment;
import com.a_track_it.fitdata.fragment.ICustomConfirmDialog;
import com.a_track_it.fitdata.fragment.MapsFragment;
...
import com.a_track_it.fitdata.fragment.ShootingConfirmFragment;
...
import static com.a_track_it.fitdata.activity.RoutineActivity.ARG_WORKOUT_OBJECT;
...
public class MainActivity extends BaseActivity implements FragmentInterface, OnCustomListItemSelectedListener,
   ...
   /// private static final int REQUEST_RECORDING_PERMISSION_CODE = 5007;
    ...
    public static final String ACTION_ADD_ACTIVITY = "com.a_track_it.fitdata.ADD_ACTIVITY";
                ...
                if (resultCode == Activity.RESULT_OK) {
                    ...
                    if (result != null) {
                        ...
                        if (mGoogleAccount != null) {
                            ...
                            onSignIn(false); // checks the sign-on
                        }else
                            signIn();
                    }else
                        signIn();
        ...
        switch (intentString) {
            ...
            case INTENT_GOAL_TRIGGER:
                ...
                notifyBuilder = new NotificationCompat
                        ...
                        .setSmallIcon(com.a_track_it.fitdata.common.R.drawable.ic_a_outlined)
                        .setLargeIcon(bitmap)
        ...
        mHandler.postDelayed(() -> googleSignInClient.signOut()
                .addOnCompleteListener(MainActivity.this, new OnCompleteListener<Void>() {
                    ...
                    public void onComplete(@NonNull Task<Void> task) {
                        ...
                        Bundle params = new Bundle();
                        params.putString(FirebaseAnalytics.Param.CONTENT_TYPE, "SignOut");
    ...
    private void sessionStartNextSet(){
        try {
            ...
            if ((setSize > 1) && currentSetIndex <= setSize){
                ...
                mWorkoutSet.lastUpdated = System.currentTimeMillis();
                sets.add(mWorkoutSet);
                mSessionViewModel.addWorkoutSet(0, mWorkoutSet);
                mSessionViewModel.insertWorkoutSet(mWorkoutSet);
            }
